 ...
 *
 *   $Id: modcp.php,v 1.12 2004/12/03 23:51:42 blackdeath_csmc Exp $
 *
 ***************************************************************************/
...
switch ($mode) {
    case 'delete':
        ...
        if ($confirm) {
            ...
            if (!empty($topic_id)) {
                $redirect_page = 'viewforum.php?' . POST_FORUM_URL . "=$forum_id&amp;sid=" . $userdata['sess_id'];

                $l_redirect = sprintf($lang['Click_return_forum'], '<a href="' . $redirect_page . '">', '</a>');
            } else {
                $redirect_page = 'modcp.php?' . POST_FORUM_URL . "=$forum_id&amp;sid=" . $userdata['sess_id'];
    ...
    case 'move':
        ...
        if ($confirm) {
            ...
            if ($new_forum_id != $old_forum_id) {
                ...
                phpbbi_sync('forum', $new_forum_id);

                phpbbi_sync('forum', $old_forum_id);
            ...
            if (!empty($topic_id)) {
                $redirect_page = 'viewtopic.php?' . POST_TOPIC_URL . "=$topic_id&amp;sid=" . $userdata['sess_id'];
            ...
            $message .= '<br \><br \>' . sprintf($lang['Click_return_forum'], '<a href="' . 'viewforum.php?' . POST_FORUM_URL . "=$old_forum_id&amp;sid=" . $userdata['sess_id'] . '">', '</a>');
    ...
    case 'lock':
        ...
        $message .= '<br \><br \>' . sprintf($lang['Click_return_forum'], '<a href="' . 'viewforum.php?' . POST_FORUM_URL . "=$forum_id&amp;sid=" . $userdata['sess_id'] . '">', '</a>');
    ...
    case 'split':
        ...
        if ('' != $post_id_sql) {
            ...
            if ($row = $db->sql_fetchrow($result)) {
                ...
                phpbbi_sync('topic', $new_topic_id);
                ...
                $template->assign_vars(
                    [
                        'META' => '<meta http-equiv="refresh" content="3;url=' . 'viewtopic.php?' . POST_TOPIC_URL . "=$topic_id&amp;sid=" . $userdata['sess_id'] . '">',
                    ]
                );

                $message = $lang['Topic_split'] . '<br><br>' . sprintf($lang['Click_return_topic'], '<a href="' . 'viewtopic.php?' . POST_TOPIC_URL . "=$topic_id&amp;sid=" . $userdata['sess_id'] . '">', '</a>');
    ...
    case 'ip':
        ...
        $template->assign_vars(
            [
                ...
                'U_LOOKUP_IP' => 'modcp.php?mode=ip&amp;' . POST_POST_URL . "=$post_id&amp;" . POST_TOPIC_URL . "=$topic_id&amp;rdns=$ip_this_post&amp;sid=" . $userdata['sess_id'],
            ]
        );
            ...
            do {
                ...
                $template->assign_block_vars(
                    ...
                    [
                        ...
                        'U_LOOKUP_IP' => 'modcp.php?mode=ip&amp;' . POST_POST_URL . "=$post_id&amp;" . POST_TOPIC_URL . "=$topic_id&amp;rdns=" . $row['poster_ip'] . '&amp;sid=' . $userdata['sess_id'],
                    ]
                );
            ...
            do {
                ...
                $template->assign_block_vars(
                    ...
                    [
                        ...
                        'U_PROFILE' => (ANONYMOUS == $id) ? 'modcp.php?mode=ip&amp;' . POST_POST_URL . '=' . $post_id . '&amp;' . POST_TOPIC_URL . '=' . $topic_id . '&amp;sid=' . $userdata['sess_id'] : append_sid('profile.php?mode=viewprofile&amp;' . POST_USERS_URL . "=$id"),
    ...
    default:
        ...
        while (false !== ($row = $db->sql_fetchrow($result))) {
            ...
            $u_view_topic = 'modcp.php?mode=split&amp;' . POST_TOPIC_URL . "=$topic_id&amp;sid=" . $userdata['sess_id'];
        ...
        $template->assign_vars(
            [
                'PAGINATION' => generate_pagination('modcp.php?' . POST_FORUM_URL . "=$forum_id&amp;sid=" . $userdata['sess_id'], $forum_topics, $board_config['topics_per_page'], $start),
