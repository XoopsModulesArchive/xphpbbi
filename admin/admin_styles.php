 ...
 *
 *   $Id: admin_styles.php,v 1.8 2004/11/30 21:54:46 blackdeath_csmc Exp $
 *
 *
 ***************************************************************************/
...
switch ($mode) {
    case 'addnew':
        ...
        if (isset($install_to)) {
            ...
            $message = $lang['Theme_installed'] . '<br><br>' . sprintf($lang['Click_return_styleadmin'], '<a href="' . append_sid('admin_styles.php') . '">', '</a>') . '<br><br>' . sprintf(
    ...
    case 'edit':
        ...
        if ($submit) {
            ...
            if ('edit' == $mode) {
                ...
                $message = $lang['Theme_updated'] . '<br><br>' . sprintf($lang['Click_return_styleadmin'], '<a href="' . append_sid('admin_styles.php') . '">', '</a>') . '<br><br>' . sprintf(
                    $lang['Click_return_admin_index'],
                    '<a href="' . append_sid('index.php?pane=right') . '">',
                    '</a>'
                );
                ...
                $message = $lang['Theme_created'] . '<br><br>' . sprintf($lang['Click_return_styleadmin'], '<a href="' . append_sid('admin_styles.php') . '">', '</a>') . '<br><br>' . sprintf(
                    $lang['Click_return_admin_index'],
                    '<a href="' . append_sid('index.php?pane=right') . '">',
                    '</a>'
                );
    ...
    case 'export':
        if ($_POST['export_template']) {
            ...
            $message = $lang['Theme_info_saved'] . '<br><br>' . sprintf($lang['Click_return_styleadmin'], '<a href="' . append_sid('admin_styles.php') . '">', '</a>') . '<br><br>' . sprintf(
                $lang['Click_return_admin_index'],
                '<a href="' . append_sid('index.php?pane=right') . '">',
                '</a>'
            );
