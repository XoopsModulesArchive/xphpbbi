 ...
 *
 *     $Id: admin_db_utilities.php,v 1.9 2004/12/03 23:51:41 blackdeath_csmc Exp $
 *
 ****************************************************************************/
    ...
    switch ($perform) {
        case 'backup':
            ...
            for ($i = 0, $iMax = count($tables); $i < $iMax; $i++) {
                ...
                //<<<---------------------------------------------
                //-+- Do backup compatible -- Koudanshi
                //<<<---------------------------------------------

                if ($table_name == 'ranks' or $table_name == 'smiles' or $table_name == 'session' or $table_name == 'users') {
            ...
            if ($do_gzip_compress) {
                ...
                ob_end_clean();
                echo "\x1f\x8b\x08\x00\x00\x00\x00\x00" . substr($contents, 0, -4) . gzip_PrintFourChars($Crc) . gzip_PrintFourChars($Size);
            }
            exit;
