 ...
 *
 *     $Id: admin_smilies.php,v 1.7 2004/11/30 21:54:46 blackdeath_csmc Exp $
 *
 ****************************************************************************/
...
if (isset($_GET['import_pack']) || isset($_POST['import_pack'])) {
    ...
    if (!empty($smile_pak)) {
        ...
        $message = $lang['smiley_import_success'] . '<br><br>' . sprintf($lang['Click_return_smileadmin'], '<a href="' . append_sid('admin_smilies.php') . '">', '</a>') . '<br><br>' . sprintf(
    ...
    $message = sprintf($lang['export_smiles'], '<a href="' . append_sid('admin_smilies.php?export_pack=send', true) . '">', '</a>') . '<br><br>' . sprintf($lang['Click_return_smileadmin'], '<a href="' . append_sid('admin_smilies.php') . '">', '</a>') . '<br><br>' . sprintf(
        $lang['Click_return_admin_index'],
        '<a href="' . append_sid('index.php?pane=right') . '">',
        '</a>'
    );
    ...
    switch ($mode) {
        case 'delete':
            ...
            $message = $lang['smiley_del_success'] . '<br><br>' . sprintf($lang['Click_return_smileadmin'], '<a href="' . append_sid('admin_smilies.php') . '">', '</a>') . '<br><br>' . sprintf(
                $lang['Click_return_admin_index'],
                '<a href="' . append_sid('index.php?pane=right') . '">',
                '</a>'
            );
        ...
        case 'save':
            ...
            $message = $lang['smiley_edit_success'] . '<br><br>' . sprintf($lang['Click_return_smileadmin'], '<a href="' . append_sid('admin_smilies.php') . '">', '</a>') . '<br><br>' . sprintf(
                $lang['Click_return_admin_index'],
                '<a href="' . append_sid('index.php?pane=right') . '">',
                '</a>'
            );
        ...
        case 'savenew':
            ...
            $message = $lang['smiley_add_success'] . '<br><br>' . sprintf($lang['Click_return_smileadmin'], '<a href="' . append_sid('admin_smilies.php') . '">', '</a>') . '<br><br>' . sprintf(
                $lang['Click_return_admin_index'],
                '<a href="' . append_sid('index.php?pane=right') . '">',
                '</a>'
            );
    ...
    for ($i = 0, $iMax = count($smilies); $i < $iMax; $i++) {
        ...
        $template->assign_block_vars(
            ...
            [
                ...
                'U_SMILEY_EDIT' => append_sid('admin_smilies.php?mode=edit&amp;id=' . $smilies[$i]['id']),
                'U_SMILEY_DELETE' => append_sid('admin_smilies.php?mode=delete&amp;id=' . $smilies[$i]['id']),
            ]
        );
    }
