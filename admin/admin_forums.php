 ...
 *
 *   $Id: admin_forums.php,v 1.8 2004/12/03 23:51:41 blackdeath_csmc Exp $
 *
 ***************************************************************************/
...
if (!empty($mode)) {
    switch ($mode) {
        ...
        case 'cat_order':
            ...
            break;
        case 'forum_sync':
            phpbbi_sync('forum', (int)$_GET[POST_FORUM_URL]);
            $show_index = true;
