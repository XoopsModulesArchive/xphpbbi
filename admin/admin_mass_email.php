 ...
 *
 *     $Id: admin_mass_email.php,v 1.7 2004/11/30 21:54:46 blackdeath_csmc Exp $
 *
 ****************************************************************************/
...
if (isset($_POST['submit'])) {
    ...
    $groupid = (int)$_POST[POST_GROUPS_URL];

    $sql = (-1 != $groupid) ? 'SELECT u.email FROM ' . USERS_TABLE . ' u, ' . USER_GROUP_TABLE . " ug WHERE ug.groupid = $groupid AND u.uid = ug.uid" : 'SELECT email FROM ' . USERS_TABLE;
    ...
    if ($row = $db->sql_fetchrow($result)) {
        ...
        $message = (-1 != $groupid) ? $lang['Group_not_exist'] : $lang['No_such_user'];
