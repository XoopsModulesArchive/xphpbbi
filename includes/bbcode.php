 ...
 *
 *   $Id: bbcode.php,v 1.8 2004/12/03 23:51:42 blackdeath_csmc Exp $
 *
 ***************************************************************************/
...
function smilies_pass($message)
{
    ...
    if (!isset($orig)) {
        ...
        for ($i = 0, $iMax = count($smilies); $i < $iMax; $i++) {
            ...
            $repl[] = '<img src="' . $board_config['smilies_path'] . '/' . $smilies[$i]['smile_url'] . '" alt="' . $smilies[$i]['emotion'] . '" border="0">';
        }
    }
...
function xbbcode($text)
{
    global $xoopsDB, $xoopsUser, $xoopsTpl;

    //+-----------------------------------------------

    //| Koudanshi Hack BBcode compatibility
