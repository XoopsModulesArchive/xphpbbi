 ...
 *
 *   $Id: usercp_viewprofile.php,v 1.8 2004/12/03 23:51:43 blackdeath_csmc Exp $
 *
 *
 ***************************************************************************/
...
$temp_url = "javascript:openWithSelfMain('" . XOOPS_URL . '/pmlite.php?send2=1&to_userid=' . $profiledata['uid'] . "', 'pmlite', 450, 380);";
$pm_img = '<a href="' . $temp_url . '"><img src="' . $images['icon_pm'] . '" alt="' . $lang['Send_private_message'] . '" title="' . $lang['Send_private_message'] . '" border="0"></a>';
$pm = '<a href="' . $temp_url . '">' . $lang['Send_private_message'] . '</a>';

if (!empty($profiledata['user_viewemail']) || ADMIN == $userdata['user_level']) {
    $email_uri = ($board_config['board_email_form']) ? append_sid('profile.php?mode=email&amp;' . POST_USERS_URL . '=' . $profiledata['uid']) : 'mailto:' . $profiledata['email'];
...
$temp_url = append_sid('search.php?search_author=' . urlencode($profiledata['uname']) . '&amp;showresults=posts');
...
$template->assign_vars(
    [
        ...
        'U_SEARCH_USER' => append_sid('search.php?search_author=' . urlencode($profiledata['uname'])),
