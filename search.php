 ...
 *
 *   $Id: search.php,v 1.8 2004/12/03 23:51:42 blackdeath_csmc Exp $
 *
 *
 ***************************************************************************/
...
$show_results = ('topics' == $show_results) ? 'topics' : 'posts';
    ...
    if ('' != $search_results) {
        ...
        for ($i = 0, $iMax = count($searchset); $i < $iMax; $i++) {
            ...
            if ('posts' == $show_results) {
                ...
                $poster = (ANONYMOUS != $searchset[$i]['uid']) ? '<a href="' . append_sid('profile.php?mode=viewprofile&amp;' . POST_USERS_URL . '=' . $searchset[$i]['uid']) . '">' : '';
                ...
                if (is_object($xoopsUser) && $searchset[$i]['post_time'] > $userdata['user_lastvisit']) {
                            ...
                            if (!empty($tracking_topics) || !empty($tracking_forums) || isset($HTTP_COOKIE_VARS[$board_config['cookie_name'] . '_f_all'])) {
                                ...
                                if ($unread_topics) {
                                    ...
                                    $newest_post_img = '<a href="'
                                                       . append_sid('viewtopic.php?' . POST_TOPIC_URL . "=$topic_id&amp;view=newest")
                                                       . '"><img src="'
                ...
                $topic_author = (ANONYMOUS != $searchset[$i]['uid']) ? '<a href="' . append_sid('profile.php?mode=viewprofile&amp;' . POST_USERS_URL . '=' . $searchset[$i]['uid']) . '">' : '';
                ...
                $last_post_author = (ANONYMOUS == $searchset[$i]['id2']) ? (('' != $searchset[$i]['post_username2']) ? $searchset[$i]['post_username2'] . ' ' : $lang['Guest'] . ' ') : '<a href="'
                                                                                                                                                                                        . append_sid('profile.php?mode=viewprofile&amp;' . POST_USERS_URL . '=' . $searchset[$i]['uid'])
                                                                                                                                                                                        . '">'
                                                                                                                                                                                        . $searchset[$i]['user2']
                                                                                                                                                                                        . '</a>';

                $last_post_url = '<a href="'
                                 . append_sid('viewtopic.php?' . POST_POST_URL . '=' . $searchset[$i]['topic_last_post_id'])
                                 . '#'
